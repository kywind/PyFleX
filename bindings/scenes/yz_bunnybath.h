...
public:
                    ...
                    int thread_idx = 0)
	{
		...
		CreateParticleShape(GetFilePathByPlatform(bunny_path).c_str(), Vec3(x_0, -0.0155f, z_0), 0.5f, 0.0f, s, Vec3(0.0f, 0.0f, 0.0f), m, true, 1.0f, NvFlexMakePhase(group++, 0), true, 0.0f);
